...
var arra_tag_autorise=new Array('a','b','strong','p');
//la liste des tags qui sont interdit et qui seront supprimés
var arra_tag_interdit=new Array('title','o','big','blockquote','br','cite','code','div','em','font','form',
'h1','h2','h3','h4','h5','h6','hr','i','img','input','li','link','ol','option','pre','s','samp','select','small',
'span','style','sub','sup','table','tbody','td','textarea','tfoot','th','thead','tr','u','ul');
