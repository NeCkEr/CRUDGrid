    ...
    $.fn.extend({
        counter: function(options) {
            ...
            return this.each(function() {
                ...
                $('<div id=\"' + this.id + '_counter\"><label>' + get_msg_equation($($obj).val().length ) + '</label>' + msg + '</div>').insertAfter($obj);

                // Cache the counter selector
                var $currentCount = $("#" + this.id + "_counter" + " label");
